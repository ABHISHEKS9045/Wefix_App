...
Color colorTheme = HexColor("#6759FF");
Color tapbuttonpdf = HexColor("#6759FF");
Color pinkbtncolor = HexColor("#D95771");
Color greybg = HexColor("#A5A5A5");
Color colorText = HexColor("#333333");
Color Gradint = HexColor("#C9C4FD");
Color Gradint2 = HexColor("#6759FF");
...
Widget dividerHorizontal(context, width, height) {
  return Center(
    child: Container(
      ...
      decoration: BoxDecoration(color: colorWhite, borderRadius: borderRadiuscircular(20.0)),
      height: height,
    ),
  );
}
