                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            sizedboxwidth(10.0),
                            Text("${widget.product_name}", overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 25, fontWeight: fontWeight600)),
                          ],
                        ),
                        const SizedBox(
                          height: 6,
                                                      ...
                                                      SizedBox(
                                                        ...
                                                        child: ClipOval(
                                                            child: model.vendorList[index]['image'] == null
                                                                ? Image.asset('assets/images/empty_user.png')
                                                                : Image.network(
                                                                    //  "http://134.209.229.112/WeFix/public//images/products/202301191227iPhon.jpg"
                                                                    model.vendorList[index]['image'],
                                                                    fit: BoxFit.cover,
                                                                    errorBuilder: (context, url, error) => const Image(image: AssetImage('assets/images/empty_user.png'), fit: BoxFit.cover),
                                                                  )),
                                                      )
                                                    ],
                                                  ),
  ...
  return Container(
    child: TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: 'Enter Your descriptions ',
      ),
    ),
  );
}
