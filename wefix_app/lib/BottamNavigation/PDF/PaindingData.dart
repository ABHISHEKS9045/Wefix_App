                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return Container(
                              ...
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), border: Border.all(color: greybg.withOpacity(0.5))),
                                      ...
                                      Container(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                                data['product_name'],
                                                style: TextStyle(fontSize: 16, color: HexColor("#1A1D1F"), fontWeight: fontWeight600)),
                                            sizedboxheight(4.0),
                                            Row(
                                              children: [
                                                Text(
                                                    data['order_id'].toString() == "null" ? "00:00 AM" : data['order_id'].toString(),
...
Future<void> _launchUrl() async {
  final Uri _url = Uri.parse("tel://123456");
