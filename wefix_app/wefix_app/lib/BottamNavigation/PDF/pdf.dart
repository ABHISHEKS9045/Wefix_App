...
import '../Serach/submitInvoicepage.dart';
...
class _pdfpageState extends State<pdfpage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((timeStamp) async {
      ...
      print("Invocesdataconfirem list ====>$Invocesdata");
    });
  }
                      ...
                      children: [
                        Button(
                            ...
                            onPressed: () {
                              setState(() {
                                selectAll = 1;
                                model.loadConfirmedProposalList(context);
                                model.loadProposalCount(context);
                              });
                            }),
                        Button(
                            ...
                            btnWidth: deviceWidth(context, 0.34),
                            buttonName: "Pending(${model.countPending != "null" ? model.countPending : '0'})",
                            btnHeight: 40.0,
                            onPressed: () {
                              setState(() {
                                selectAll = 2;
                                model.loadPendingProposalList(context);
                                model.loadProposalCountp(context);
                        ...
                        Button(
                            ...
                            onPressed: () {
                              setState(() {
                                selectAll = 3;
                                model.loadHistoryProposalList(context);
                              });
                            }),
                      ],
                    ),
                                        ...
                                        isVendor
                                          ...
                                          children: [
                                            Container(
                                              alignment: Alignment.center,
                                              height: 45,
                                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: HexColor("#EFEEFF")),
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    data['order_amount'].toString(),
                                                    // "1800 ",
                                                    style: TextStyle(fontSize: 18, fontWeight: fontWeight500, color: HexColor("#6759FF")),
                                                  ),
                                                ],
                                              ),
                                            ),
                                                  ...
                                                  InkWell(
                                                    onTap: () {
                                                      Navigator.push(
                                                          context,
                                                          MaterialPageRoute(
                                                            builder: (context) => SubmitInvoicepage(
                                                              invoiceData : model.confirmedList[index],
      ...
      return RefreshIndicator(
        ...
        ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return
                Container(
                margin: const EdgeInsets.only(bottom: 25, right: 5, left: 5),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Html(
                          data: data['status'] == null ? (data['description'] ??= '') : (data['note'] ??= ''),
                        ),
                        Container(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  const Spacer(),
                                  Text(data['order_status'], style: TextStyle(fontSize: 17, color: colorTheme)),
                                ],
                              ),
                            ],
                          ),
