...
BottomNavigationBar bottomNavBarPagewidget(context, model) {
  return BottomNavigationBar(
    ...
    selectedIconTheme: IconThemeData(color: colorTheme, size: 10),
    selectedLabelStyle: TextStyle(fontWeight: fontWeight700, color: colorTheme),
      ...
      BottomNavigationBarItem(
        icon: SizedBox(
            ...
            child: Image(
              ...
              color: model.bottombarzindex == 0 ? colorTheme : Colors.grey,
            )),
        label: '',
      ),
      BottomNavigationBarItem(
          icon: SizedBox(
              ...
              child: Image(
                ...
                color: model.bottombarzindex == 1 ? colorTheme : Colors.grey,
              )),
          label: ''),
      BottomNavigationBarItem(
          icon: SizedBox(
              ...
              child: Image(
                ...
                color: model.bottombarzindex == 2 ? colorTheme : Colors.grey,
              )),
          label: ''),
      BottomNavigationBarItem(
          ...
          icon: SizedBox(
              ...
              child: Image(
                ...
                color: model.bottombarzindex == 3 ? colorTheme : Colors.grey,
              )),
          label: ''),
    ],
  );
